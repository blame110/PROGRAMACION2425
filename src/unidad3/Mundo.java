...
public class Mundo {
	...
	/**
	 * Mueve al enemigo hacia la posicion del jugador
	 * y si lo tiene cerca acaba con el y finaliza el juego devolviendo true
	...
	public boolean moverEnemigo() {
		...
		if (Math.abs(enemigo.getPosX() - jugador.getPosX()) > Math.abs(enemigo.getPosY() - jugador.getPosY())) {
			//Si la posicion X del enemigo es inferior a la del jugador me voy pa la derecha
